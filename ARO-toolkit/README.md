...
2.  Click on More Services &gt;
    ...
    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image3.png">
<br>

3.  <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image4.png">
    

4.  In the search window, type “**Templates**” which will display the
    Templates

    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image5.png">
...
9.  Fill all the mandatory input parameters
    ...
    **Note1:** Click <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image6.png">
    ...
    **Note2:** Make sure you provide your own service account in the
    ...
    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image7.png">

10. Select the checkbox (Terms and Conditions)

    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image8.png">
    

11. Click “**Purchase**” button to start the deployment

    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image9.png">
...
2.  Click on “**Automation Accounts**” from the service blade
    ...
    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image10.png">
...
5.  Click “**Assets**”
    ...
    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image11.png">
    

6.  Click “**Variables**” tile

    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image12.png">
...
8.  Update the variables as per your requirements
    ...
    **Note:** If you want to act on all the VM’s at subscription level,
    ...
    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image13a.png">
...
3.  Click on “**Schedules**”
    ...
    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image14a.png">
...
5.  Click “**Yes**” in the Enabled attribute and click “**Save**”
    ...
    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image15.png">
...
2.  Click on “Add a schedule”
    ...
    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image16.png">
...
4.  Click on “**Create**”
    ...
    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image17.png">
    

5.  Click on “Runbooks” to link the runbook to the above created
    schedule.

    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image18.png">
...
7.  After selecting the runbook, click on “**Schedules**” tile.
    ...
    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image19.png">

8.  Click on “**Add a schedule**”

    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image20.png">
    

9.  Click on “**Link a schedule to your runbook**”

    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image21.png">

10. Select the schedule which you have created earlier. In this example,
    it is “TestSchedule1” so select that

    <img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image22.png">
...
<img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image23.png">


1.  Once this completes, navigate to the Bootstrap\_Main runbook and
    start it.

<img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image24.png">


<img src="https://armnptemplates.blob.core.windows.net/armv3/master/images/AROToolkit/image25.png">
